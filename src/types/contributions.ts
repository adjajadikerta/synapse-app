...
export type ContributionStatus = 'pending' | 'approved' | 'rejected' | 'under-review';
...
export interface AddPaperContribution extends BaseContribution {
  type: 'add-paper';
  data: PaperSuggestion;
}

export interface EditSummaryContribution extends BaseContribution {
  type: 'edit-summary';
  data: SummaryEdit;
}

export interface FlagMethodologyContribution extends BaseContribution {
  type: 'flag-methodology';
  data: MethodologyFlag;
}

export interface SuggestTopicContribution extends BaseContribution {
  type: 'suggest-topic';
  data: TopicSuggestion;
}

export interface AddMethodologyDetailsContribution extends BaseContribution {
  type: 'add-methodology-details';
  data: MethodologyDetails;
}

export interface CorrectPaperInfoContribution extends BaseContribution {
  type: 'correct-paper-info';
  data: PaperCorrection;
}

export interface SuggestPaperTopicsContribution extends BaseContribution {
